...
bool Cell::isPeach(){                       // ЕСЛИ КОНПКА ЦВЕТА PEACH, ТО TRUE, ИНАЧЕ FALSE
    return nameImage.contains("peach");
    /*
    if(nameImage == "peach"){
        return true;
    }
    ...
    else if(nameImage == "white_queen_peach"){
        return true;
    }
    else if(nameImage == "black_queen_peach"){
        return true;
    }
    else if(nameImage == "white_king_peach"){
        return true;
    }
    else if(nameImage == "black_king_peach"){
        return true;
    }
    else return false;
    */
...
bool Cell::isMaroon(){                     // ЕСЛИ КОНПКА ЦВЕТА MAROON, ТО TRUE, ИНАЧЕ FALSE
    return nameImage.contains("maroon");
    /*
    if(nameImage == "maroon"){
        return true;
    }
    else if(nameImage == "white_pawn_maroon"){
        return  true;
    }
    else if(nameImage == "black_pawn_maroon"){
        return  true;
    }
    else if(nameImage == "white_rook_maroon"){
        return true;
    }
    else if(nameImage == "black_rook_maroon"){
        return true;
    }
    else if(nameImage == "white_knight_maroon"){
        return true;
    }
    else if(nameImage == "black_knight_maroon"){
        return true;
    }
    else if(nameImage == "white_bishop_maroon"){
        return true;
    }
    else if(nameImage == "black_bishop_maroon"){
        return true;
    }
    else if(nameImage == "white_queen_maroon"){
        return true;
    }
    else if(nameImage == "black_queen_maroon"){
        return true;
    }
    else if(nameImage == "white_king_maroon"){
        return true;
    }
    else if(nameImage == "black_king_maroon"){
        return true;
    }
    else return false;
    */
...
bool Cell::hasFigure(){                     // ЕСЛИ НА КНОПКЕ ЕСТЬ ФИГУРА, ТО TRUE, ИНАЧЕ FALSE
    return nameImage.contains("white") || nameImage.contains("black");
    ...
    else if(nameImage == "white_king_maroon") return true;
    else if(nameImage == "white_king_peach") return true;
    else if(nameImage == "black_king_maroon") return true;
    else if(nameImage == "black_king_peach") return true;

    else if(nameImage == "white_queen_maroon") return true;
    else if(nameImage == "white_queen_peach") return true;
    else if(nameImage == "black_queen_maroon") return true;
    else if(nameImage == "black_queen_peach") return true;
